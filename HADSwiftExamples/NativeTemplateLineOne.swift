...
class NativeTemplateLineOne: UIViewController, HADBannerTemplateViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        bannerTemplateView.loadAd("5b3QbMRQ", bannerTemplate: .LineOne, delegate: self)
        ...
        bannerTemplateView.customAgeRatingTextColor = UIColor.whiteColor()
        bannerTemplateView.customAgeRatingBackgroundColor = UIColor.purpleColor()
