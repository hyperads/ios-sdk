...
#import "NativeTemplateBlockTwo.h"

@interface NativeTemplateBlockTwo () <HADBannerTemplateViewDelegate>
@property (weak, nonatomic) IBOutlet HADBannerTemplateView *bannerTemplateView;
@end

@implementation NativeTemplateBlockTwo

-(void)viewDidLoad {
    [super viewDidLoad];
    //Just set HADBannerTemplateTypes param in loadAd method
    [self.bannerTemplateView loadAdWithPlacementId:@"5b3QbMRQ" bannerTemplate:HADBannerTemplateTypesBlockTwo delegate:self];
