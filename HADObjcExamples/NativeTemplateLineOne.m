...
#import "NativeTemplateLineOne.h"

@interface NativeTemplateLineOne () <HADBannerTemplateViewDelegate>
@property (weak, nonatomic) IBOutlet HADBannerTemplateView *bannerTemplateView;
@end

@implementation NativeTemplateLineOne

-(void)viewDidLoad {
    [super viewDidLoad];
    //Just set HADBannerTemplateTypes param in loadAd method
    [self.bannerTemplateView loadAdWithPlacementId:@"5b3QbMRQ" bannerTemplate:HADBannerTemplateTypesLineOne delegate:self];
