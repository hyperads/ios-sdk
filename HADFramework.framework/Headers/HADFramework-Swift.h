...
/**
  Typed access to the ad cover image creative. See \code
  HADAdImage
  \endcode for details.
*/
@property (nonatomic, readonly, strong) HADAdImage * _Nullable cover;
/**
  Typed access to the ad icon. See \code
  HADAdImage
  \endcode for details.
*/
...
*/
- (HADNativeAd * _Nullable)nativeAdWithCollectionView:(UICollectionView * _Nonnull)collectionView forIndexPath:(NSIndexPath * _Nonnull)indexPath;
/**
...
*/
- (BOOL)isAdCellWithIndexPath:(NSIndexPath * _Nonnull)indexPath forStride:(NSInteger)stride;
/**
...
*/
- (NSIndexPath * _Nullable)adjustNonAdCellWithIndexPath:(NSIndexPath * _Nonnull)indexPath forStride:(NSInteger)stride;
/**
...
*/
- (NSInteger)adjustCountWithCount:(NSInteger)count forStride:(NSInteger)stride;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
/**
  ...
  \param type The type of this native ad template. For more information, consult \code
  HADNativeAdViewType
  \endcode
...
*/
- (UICollectionViewCell * _Nullable)cellOf:(UICollectionView * _Nonnull)collectionView forRowAt:(NSIndexPath * _Nonnull)indexPath;
/**
...
*/
- (CGSize)sizeOf:(UICollectionView * _Nonnull)collectionView forRowAt:(NSIndexPath * _Nonnull)indexPath;
...
*/
- (HADNativeAd * _Nullable)nativeAdWithTableView:(UITableView * _Nonnull)tableView forIndexPath:(NSIndexPath * _Nonnull)indexPath;
/**
...
*/
- (UITableViewCell * _Nullable)cellOf:(UITableView * _Nonnull)tableView forRowAt:(NSIndexPath * _Nonnull)indexPath;
/**
...
*/
- (CGFloat)heightOf:(UITableView * _Nonnull)tableView forRowAt:(NSIndexPath * _Nonnull)indexPath;
/**
  Helper method for implementors of UITableViewDelegate who would like to host native ad UITableViewCells in their table view.
*/
- (CGFloat)estimatedHeightOf:(UITableView * _Nonnull)tableView forRowAt:(NSIndexPath * _Nonnull)indexPath;
- (nonnull instancetype)initWithManager:(HADNativeAdsManager * _Nonnull)manager SWIFT_UNAVAILABLE;
@end
...
*/
+ (HADNativeAdView * _Nonnull)nativeAdViewWithNativeAd:(HADNativeAd * _Nonnull)nativeAd withType:(enum HADNativeAdViewType)type;
/**
  This is a method to create a native ad template using the given placement id and type.
  \param nativeAd The native ad to use to create this view.
...
*/
+ (HADNativeAdView * _Nonnull)nativeAdViewWithNativeAd:(HADNativeAd * _Nonnull)nativeAd withType:(enum HADNativeAdViewType)type withAttributes:(HADNativeAdViewAttributes * _Nonnull)attrs;
...
*/
+ (HADNativeAdViewAttributes * _Nonnull)defaultAttributesForTypeWithType:(enum HADNativeAdViewType)type;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (UIViewController * _Nullable)getVisibleViewControllerFromVc:(UIViewController * _Nullable)vc;
@end
